...
class ContactsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_contacts_partners1_idx' => ['type' => 'index', 'columns' => ['partner_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'email_UNIQUE' => ['type' => 'unique', 'columns' => ['email'], 'length' => []],
            'fk_contacts_partners1' => ['type' => 'foreign', 'columns' => ['partner_id'], 'references' => ['partners', 'id'], 'update' => 'noAction', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init(): void
    {
        $this->records = [
            [
                'id' => '648f3bec-b1f5-445e-b1c5-222640eef446',
                'partner_id' => 'a300296f-1d52-4ecc-a0ff-13aa5f5d6e5f',
