...
class CategoriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_categories_categories1_idx' => ['type' => 'index', 'columns' => ['parent_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_categories_categories1' => ['type' => 'foreign', 'columns' => ['parent_id'], 'references' => ['categories', 'id'], 'update' => 'noAction', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init(): void
    {
        $this->records = [
            [
                'id' => '8ead3932-df7d-482c-9da2-2612ea0fd22b',
                'parent_id' => 'f146bc93-9285-48e1-a97b-36dab2befa1b',
                'name' => 'Lorem ipsum dolor sit amet',
                'image' => 'Lorem ipsum dolor sit amet',
                'lft' => 1,
                'rght' => 1,
                'created' => '2021-07-23 12:55:57',
                'modified' => '2021-07-23 12:55:57',
            ],
        ];
        parent::init();
    }
